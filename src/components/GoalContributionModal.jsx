...
export default function GoalContributionModal({ isOpen, onClose, goal }) {
  ...
  const newCurrent = Math.min(goal.targetAmount, goal.currentAmount + amountNum)
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-800">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Monto del aporte</label>
            <input
          ...
          <div>
            ...
            <input
              type="text" placeholder={`Aporte a ${goal.name}`}
